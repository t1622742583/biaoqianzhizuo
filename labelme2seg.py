...
def main(args):
    ...
    for label_file in glob.glob(osp.join(args.input_dir, '*.json')):
        ...
        with open(label_file) as f:
            ...
            # 取绝对路径
            img_file = osp.abspath(img_file)
            print('img_file:', img_file)
            img = np.asarray(cv_imread(img_file))
...
def parse_args():
    ...
    parser.add_argument('--input_dir',default=r'E:\A-输送管识别\yeguan_0908\json', help='input annotated directory')
