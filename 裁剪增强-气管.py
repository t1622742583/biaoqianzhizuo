...
for out_size in tqdm([random.randint(100,200),random.randint(200,300),random.randint(300,400)]):
    save_idx = 0
    image_path = r"E:\A-输送管识别\输出管正确连接输送管连接输送管移除连接0902\images"
    save_path = rf"E:\A-输送管识别\qiguan"
    labels_path = r"E:\A-输送管识别\输出管正确连接输送管连接输送管移除连接0902\labels"
    ...
    for label in label_lists:
        ...
        if label_name.startswith("NVR_") or label_name.startswith("ssglj"):
