...
def parse_args():
    ...
    parser.add_argument('--dataset_root',default=r'E:\A-输送管识别\yeguan_0908', help='the dataset root path', type=str)
    parser.add_argument(
        '--images_dir_name',default='images' ,help='the directory name of images', type=str)
    parser.add_argument(
        '--labels_dir_name', default='annotations' ,help='the directory name of labels', type=str)
    parser.add_argument(
